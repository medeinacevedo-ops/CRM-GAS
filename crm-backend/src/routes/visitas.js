...
const { registrarVisita, listarVisitasAdmin, getVisitsByLead, editarVisitaAdmin, eliminarVisitaAdmin } = require("../controllers/visitasController");
...
router.delete("/:id", requireAuth, requireRole("admin"), eliminarVisitaAdmin);
